    ...
    <div class="bg-slate-100 h-screen flex">
        ...
        <div class="w-1/2  h-screen flex flex-col justify-center ml-8">
            <div class="box-login h-fit flex flex-col gap-4 w-1/3">
                <input  class="p-1 border-gray-400 outline-none" type="text" placeholder="Email or phone number"/>
                <input class="p-1 border-gray-400 outline-none" type="password" placeholder="password" />
